...
Download link:      https://github.com/xxsimoxx/cpcompatibility/releases/download/v1.1.2/cpcompatibility-1.1.2.zip
License:            GPLv2
...
* Add a menu under "tools" that displays top 500 plugins from wp.org and their compatibility
...
= 1.1.1 =
* Don't load the fix for wp-cli if it's in core as PR #811
* Fix code for cpcs
